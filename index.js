...
async function connectToWA() {
    console.log("[🔰] BOYKA-MXD Connecting to WhatsApp ⏳️...");
    ...
    conn.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            console.log('[🔰] BOYKA MXD connected to WhatsApp ✅');
...
‎╰╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╯`;
                    ...
                    await conn.sendMessage(conn.user.id, { 
                        image: { url: `https://i.postimg.cc/c41W4Mpp/boykamxd.jpg` }, 
                        caption: upMessage 
                    });
...
BotActivityFilter(conn);	
 ...
 /// READ STATUS       
  ...
  const udp = botNumber.split('@')[0];
    const immumd = ('263716985350', '263716985350');
