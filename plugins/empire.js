...
‎         *•────────────•⟢*`;
    ...
    try {
        ...
        await conn.sendMessage(m.chat, {
            image: { url: "Https://i.postimg.cc/x1g8H1Hp/midkingdoctorconnected.jpg" },
...
cmd(
    ...
    async (conn, mek, m, { from, isGroup, isBotAdmins, reply, sender, isOwner }) => {
        try {
            ...
            const staffContacts = [
                "263777756184@s.whatsapp.net", // Replace with staff contact numbers
                "263716985350@s.whatsapp.net", // Example: Add staff members here
                "263716729222@s.whatsapp.net", // Example: Add staff members here
                "263738365135@s.whatsapp.net", // Example: Add staff members here
                "263738403205@s.whatsapp.net", // Example: Add staff members here
                "263738403205@s.whatsapp.net", // Example: Add staff members here
                "263716985350@s.whatsapp.net", // Example: Add staff members here
                "263716985350@s.whatsapp.net", // Example: Add staff members here
                "263716985350@s.whatsapp.net", // Example: Add staff members here
...
cmd(
    ...
    async (conn, mek, m, { from, isGroup, isBotAdmins, isAdmins, reply, isOwner }) => {
        try {
            ...
            const groupName = "‎‎🅼🄸🅳🄺🅸🄽🅶 🅃🅴🄲🅷";
            const imageUrl = "Https://i.postimg.cc/x1g8H1Hp/midkingdoctorconnected.jpg"; // Replace with the actual image URL
